...
public class Lab0PrintReceipt {
	...
	public static void main(String[] args) {
		...
		System.out.printf("%5s\t%-25s\t%15s\t%15s%n", "#", "Description", "Unit Price", "Total Price");
		...
		System.out.printf("%5d\t%-25s\t%15.2f\t%15.2f%n", qtyTV, TV, UP_TV, tpTV); // TVs
		System.out.printf("%5d\t%-25s\t%15.2f\t%15.2f%n", qtyVCR, VCR, UP_VCR, tpVCR); // VCRs
		System.out.printf("%5d\t%-25s\t%15.2f\t%15.2f%n", qtyRC, RC, UP_RC, tpRC); // Remote Controllers
		System.out.printf("%5d\t%-25s\t%15.2f\t%15.2f%n", qtyCDP, CDP, UP_CDP, tpCDP); // CD Players
		System.out.printf("%5d\t%-25s\t%15.2f\t%15.2f%n", qtyTR, TR, UP_TR, tpTR); // Tape Recorders
		...
		System.out.printf("%40s%20.2f%n", "TAX @ 8.25%", tax);

		// ALTERNATE PRINT STATEMENT WITHOUT SHOWING THE TAX RATE PERCENT
		System.out.printf("%40s%20.2f%n", "TAX", tax);
		...
		System.out.printf("%40s%20.2f%n", "TOTAL", total);
